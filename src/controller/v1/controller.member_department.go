...
func (c *Controller) MemberDepartmentController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "GET",
		ResponseType: model_core.MemberDepartmentHistory{},
		...
		memberDepartmentHistory, err := c.model_core.MemberDepartmentHistoryCurrentBranch(context, user.OrganizationID, *user.BranchID)
		if err != nil {
			return ctx.JSON(http.StatusInternalServerError, map[string]string{"error": "Failed to get member department history: " + err.Error()})
		}
		return ctx.JSON(http.StatusOK, c.model_core.MemberDepartmentHistoryManager.Filtered(context, ctx, memberDepartmentHistory))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "GET",
		ResponseType: model_core.MemberDepartmentHistoryResponse{},
		...
		memberDepartmentHistory, err := c.model_core.MemberDepartmentHistoryMemberProfileID(context, *memberProfileID, user.OrganizationID, *user.BranchID)
		if err != nil {
		...
		return ctx.JSON(http.StatusOK, c.model_core.MemberDepartmentHistoryManager.Pagination(context, ctx, memberDepartmentHistory))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "GET",
		ResponseType: model_core.MemberDepartmentResponse{},
		...
		memberDepartment, err := c.model_core.MemberDepartmentCurrentBranch(context, user.OrganizationID, *user.BranchID)
		if err != nil {
			return ctx.JSON(http.StatusInternalServerError, map[string]string{"error": "Failed to get member departments: " + err.Error()})
		}
		return ctx.JSON(http.StatusOK, c.model_core.MemberDepartmentManager.Filtered(context, ctx, memberDepartment))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		return ctx.JSON(http.StatusOK, c.model_core.MemberDepartmentManager.Pagination(context, ctx, memberDepartment))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "POST",
		ResponseType: model_core.MemberDepartmentResponse{},
		RequestType:  model_core.MemberDepartmentRequest{},
		Note:         "Creates a new member department record.",
	}, func(ctx echo.Context) error {
		context := ctx.Request().Context()
		req, err := c.model_core.MemberDepartmentManager.Validate(ctx)
		if err != nil {
		...
		memberDepartment := &model_core.MemberDepartment{
			Name:           req.Name,
		...
		if err := c.model_core.MemberDepartmentManager.Create(context, memberDepartment); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusOK, c.model_core.MemberDepartmentManager.ToModel(memberDepartment))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		memberDepartment, err := c.model_core.MemberDepartmentManager.GetByID(context, *memberDepartmentID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.model_core.MemberDepartmentManager.UpdateFields(context, memberDepartment.ID, memberDepartment); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		value, err := c.model_core.MemberDepartmentManager.GetByID(context, *memberDepartmentID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
		...
		if err := c.model_core.MemberDepartmentManager.DeleteByID(context, *memberDepartmentID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		for _, rawID := range reqBody.IDs {
			...
			names += value.Name + ","
			if err := c.model_core.MemberDepartmentManager.DeleteByIDWithTx(context, tx, memberDepartmentID); err != nil {
				tx.Rollback()
				c.event.Footstep(context, ctx, event.FootstepEvent{
					Activity:    "bulk-delete-error",
