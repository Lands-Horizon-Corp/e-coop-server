...
func (c *Controller) MemberDepartmentController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "GET",
		ResponseType: model.MemberDepartmentHistory{},
		...
		memberDepartmentHistory, err := c.model.MemberDepartmentHistoryCurrentBranch(context, user.OrganizationID, *user.BranchID)
		if err != nil {
			return ctx.JSON(http.StatusInternalServerError, map[string]string{"error": "Failed to get member department history: " + err.Error()})
		}
		return ctx.JSON(http.StatusOK, c.model.MemberDepartmentHistoryManager.Filtered(context, ctx, memberDepartmentHistory))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "GET",
		ResponseType: model.MemberDepartmentHistoryResponse{},
		...
		memberDepartmentHistory, err := c.model.MemberDepartmentHistoryMemberProfileID(context, *memberProfileID, user.OrganizationID, *user.BranchID)
		if err != nil {
		...
		return ctx.JSON(http.StatusOK, c.model.MemberDepartmentHistoryManager.Pagination(context, ctx, memberDepartmentHistory))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "GET",
		ResponseType: model.MemberDepartmentResponse{},
		...
		memberDepartment, err := c.model.MemberDepartmentCurrentBranch(context, user.OrganizationID, *user.BranchID)
		if err != nil {
			return ctx.JSON(http.StatusInternalServerError, map[string]string{"error": "Failed to get member departments: " + err.Error()})
		}
		return ctx.JSON(http.StatusOK, c.model.MemberDepartmentManager.Filtered(context, ctx, memberDepartment))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		return ctx.JSON(http.StatusOK, c.model.MemberDepartmentManager.Pagination(context, ctx, memberDepartment))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "POST",
		ResponseType: model.MemberDepartmentResponse{},
		RequestType:  model.MemberDepartmentRequest{},
		Note:         "Creates a new member department record.",
	}, func(ctx echo.Context) error {
		context := ctx.Request().Context()
		req, err := c.model.MemberDepartmentManager.Validate(ctx)
		if err != nil {
		...
		memberDepartment := &model.MemberDepartment{
			Name:           req.Name,
		...
		if err := c.model.MemberDepartmentManager.Create(context, memberDepartment); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusOK, c.model.MemberDepartmentManager.ToModel(memberDepartment))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		memberDepartment, err := c.model.MemberDepartmentManager.GetByID(context, *memberDepartmentID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.model.MemberDepartmentManager.UpdateFields(context, memberDepartment.ID, memberDepartment); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		value, err := c.model.MemberDepartmentManager.GetByID(context, *memberDepartmentID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
		...
		if err := c.model.MemberDepartmentManager.DeleteByID(context, *memberDepartmentID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		for _, rawID := range reqBody.IDs {
			...
			names += value.Name + ","
			if err := c.model.MemberDepartmentManager.DeleteByIDWithTx(context, tx, memberDepartmentID); err != nil {
				tx.Rollback()
				c.event.Footstep(context, ctx, event.FootstepEvent{
					Activity:    "bulk-delete-error",
