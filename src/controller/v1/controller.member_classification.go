...
func memberClassificationController(service *horizon.HorizonService) {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		memberClassificationHistory, err := core.MemberClassificationHistoryCurrentBranch(context, userOrg.OrganizationID, *userOrg.BranchID)
		if err != nil {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		memberClassificationHistory, err := core.MemberClassificationHistoryManager(service).NormalPagination(context, ctx, &core.MemberClassificationHistory{
	...
	req.RegisterWebRoute(horizon.Route{
		...
		memberClassification, err := core.MemberClassificationCurrentBranch(context, userOrg.OrganizationID, *userOrg.BranchID)
		if err != nil {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		value, err := core.MemberClassificationManager(service).NormalPagination(context, ctx, &core.MemberClassification{
			OrganizationID: userOrg.OrganizationID,
			BranchID:       *userOrg.BranchID,
		})
		if err != nil {
