...
func (c *Controller) LoanTransactionEntryController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		RequestType:  model_core.LoanTransactionDeductionRequest{},
		...
		var req model_core.LoanTransactionDeductionRequest
		...
		loanTransaction := &model_core.LoanTransactionEntry{
		...
		if err := c.model_core.LoanTransactionEntryManager.Create(context, loanTransaction); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
	...
	req.RegisterRoute(handlers.Route{
		...
		loanTransactionEntry, err := c.model_core.LoanTransactionEntryManager.GetByID(context, *loanTransactionEntryId)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "not-found",
		...
		if loanTransactionEntry.Type == model_core.LoanTransactionAutomaticDeduction {
		...
		if err := c.model_core.LoanTransactionEntryManager.UpdateFields(context, *loanTransactionEntryId, loanTransactionEntry); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
				Description: "Loan transaction deduction creation failed: " + err.Error(),
				Module:      "LoanTransaction",
	...
	req.RegisterRoute(handlers.Route{
		...
		if err := c.model_core.LoanTransactionEntryManager.Delete(context, loanTransactionEntry); err != nil {
