...
func (c *Controller) MemberRelativeAccountController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "POST",
		RequestType:  model_core.MemberRelativeAccountRequest{},
		ResponseType: model_core.MemberRelativeAccountResponse{},
		...
		req, err := c.model_core.MemberRelativeAccountManager.Validate(ctx)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		value := &model_core.MemberRelativeAccount{
		...
		if err := c.model_core.MemberRelativeAccountManager.Create(context, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusOK, c.model_core.MemberRelativeAccountManager.ToModel(value))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		value, err := c.model_core.MemberRelativeAccountManager.GetByID(context, *memberRelativeAccountID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.model_core.MemberRelativeAccountManager.UpdateFields(context, value.ID, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		if err := c.model_core.MemberRelativeAccountManager.DeleteByID(context, *memberRelativeAccountID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
