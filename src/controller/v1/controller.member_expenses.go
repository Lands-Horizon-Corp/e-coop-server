...
func (c *Controller) MemberExpenseController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "POST",
		ResponseType: model_core.MemberExpenseResponse{},
		RequestType:  model_core.MemberExpenseRequest{},
		...
		req, err := c.model_core.MemberExpenseManager.Validate(ctx)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		value := &model_core.MemberExpense{
		...
		if err := c.model_core.MemberExpenseManager.Create(context, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusOK, c.model_core.MemberExpenseManager.ToModel(value))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		value, err := c.model_core.MemberExpenseManager.GetByID(context, *memberExpenseID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.model_core.MemberExpenseManager.UpdateFields(context, value.ID, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		if err := c.model_core.MemberExpenseManager.DeleteByID(context, *memberExpenseID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
