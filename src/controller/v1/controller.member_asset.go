...
func (c *Controller) MemberAssetController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "POST",
		RequestType:  model_core.MemberAsset{},
		ResponseType: model_core.MemberAsset{},
		...
		req, err := c.model_core.MemberAssetManager.Validate(ctx)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		if err := c.model_core.MemberAssetManager.Create(context, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusCreated, c.model_core.MemberAssetManager.ToModel(value))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		value, err := c.model_core.MemberAssetManager.GetByID(context, *memberAssetID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.model_core.MemberAssetManager.UpdateFields(context, value.ID, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		return ctx.JSON(http.StatusOK, c.model_core.MemberAssetManager.ToModel(value))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		if err := c.model_core.MemberAssetManager.DeleteByID(context, *memberAssetID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
