...
func (c *Controller) PermissionTemplateController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		return ctx.JSON(http.StatusOK, c.model.PermissionTemplateManager.Filtered(context, ctx, permissionTemplates))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		return ctx.JSON(http.StatusOK, c.model.PermissionTemplateManager.ToModel(permissionTemplate))
	})
