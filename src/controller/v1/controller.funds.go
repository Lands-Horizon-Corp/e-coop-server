...
func fundsController(service *horizon.HorizonService) {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		funds, err := core.FundsCurrentBranch(context, userOrg.OrganizationID, *userOrg.BranchID)
		if err != nil {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		funds, err := core.FundsManager(service).NormalPagination(context, ctx, &core.Funds{
