...
func loanPurposeController(service *horizon.HorizonService) {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		purposes, err := core.LoanPurposeCurrentBranch(context, userOrg.OrganizationID, *userOrg.BranchID)
		if err != nil {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		value, err := core.LoanPurposeManager(service).NormalPagination(context, ctx, &core.LoanPurpose{
