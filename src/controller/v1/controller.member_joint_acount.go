...
func (c *Controller) MemberJointAccountController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		Method:       "POST",
		ResponseType: model_core.MemberJointAccountResponse{},
		RequestType:  model_core.MemberJointAccountRequest{},
		...
		req, err := c.model_core.MemberJointAccountManager.Validate(ctx)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		value := &model_core.MemberJointAccount{
		...
		if err := c.model_core.MemberJointAccountManager.Create(context, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusOK, c.model_core.MemberJointAccountManager.ToModel(value))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		value, err := c.model_core.MemberJointAccountManager.GetByID(context, *memberJointAccountID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.model_core.MemberJointAccountManager.UpdateFields(context, value.ID, value); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		if err := c.model_core.MemberJointAccountManager.DeleteByID(context, *memberJointAccountID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
