...
func companyController(service *horizon.HorizonService) {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		companies, err := core.CompanyCurrentBranch(context, userOrg.OrganizationID, *userOrg.BranchID)
		if err != nil {
	...
	req.RegisterWebRoute(horizon.Route{
		...
		companies, err := core.CompanyManager(service).NormalPagination(context, ctx, &core.Company{
