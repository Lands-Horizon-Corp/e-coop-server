...
func (c *Controller) TransactionBatchEntriesController() {
	...
	req.RegisterRoute(handlers.Route{
		Route:        "/api/v1/check-entry/transaction-batch/:transaction_batch_id/search",
		Method:       "GET",
	...
	req.RegisterRoute(handlers.Route{
		Route:        "/api/v1/check-entry/search",
		Method:       "GET",
		ResponseType: model.CheckEntryResponse{},
	...
	req.RegisterRoute(handlers.Route{
		Route:        "/api/v1/withdrawal-entry/transaction-batch/:transaction_batch_id/search",
		Method:       "GET",
	...
	req.RegisterRoute(handlers.Route{
		Route:        "/api/v1/deposit-entry/transaction-batch/:transaction_batch_id/search",
		Method:       "GET",
