...
func (c *Controller) CashCheckVoucherTagController() {
	...
	req.RegisterRoute(handlers.Route{
		...
		tags, err := c.model.CashCheckVoucherTagCurrentBranch(context, user.OrganizationID, *user.BranchID)
		if err != nil {
	...
	req.RegisterRoute(handlers.Route{
		...
		return ctx.JSON(http.StatusOK, c.model.CashCheckVoucherTagManager.Pagination(context, ctx, tags))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		tag, err := c.model.CashCheckVoucherTagManager.GetByIDRaw(context, *tagID)
		if err != nil {
	...
	req.RegisterRoute(handlers.Route{
		...
		RequestType:  model.CashCheckVoucherTagRequest{},
		ResponseType: model.CashCheckVoucherTagResponse{},
	}, func(ctx echo.Context) error {
		context := ctx.Request().Context()
		req, err := c.model.CashCheckVoucherTagManager.Validate(ctx)
		if err != nil {
		...
		if err := c.model.CashCheckVoucherTagManager.Create(context, tag); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusCreated, c.model.CashCheckVoucherTagManager.ToModel(tag))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		tag, err := c.model.CashCheckVoucherTagManager.GetByID(context, *tagID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.model.CashCheckVoucherTagManager.UpdateFields(context, tag.ID, tag); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		return ctx.JSON(http.StatusOK, c.model.CashCheckVoucherTagManager.ToModel(tag))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		if err := c.model.CashCheckVoucherTagManager.DeleteByID(context, *tagID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
	...
	req.RegisterRoute(handlers.Route{
		...
		for _, rawID := range reqBody.IDs {
			...
			names += tag.Name + ","
			if err := c.model.CashCheckVoucherTagManager.DeleteByIDWithTx(context, tx, tagID); err != nil {
				tx.Rollback()
				c.event.Footstep(context, ctx, event.FootstepEvent{
					Activity:    "bulk-delete-error",
