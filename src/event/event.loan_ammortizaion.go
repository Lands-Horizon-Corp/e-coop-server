...
func LoanAmortization(context context.Context, service *horizon.HorizonService, loanTransactionID uuid.UUID, userOrg *core.UserOrganization) (*LoanTransactionAmortizationResponse, error) {
