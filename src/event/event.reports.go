...
// 		loanTransaction, getErr := r.core.LoanTransactionManager(service).GetByID(
...
// 		branch, err := r.core.BranchManager(service).GetByID(ctx, loanTransaction.BranchID)
// 		if err != nil {
// 			return nil, eris.Wrapf(err, "Failed to get branch by ID: %s", loanTransaction.BranchID)
// 		}
// 		memberProfile, err := r.core.MemberProfileManager(service).GetByID(ctx, *loanTransaction.MemberProfileID)
// 		if err != nil {
