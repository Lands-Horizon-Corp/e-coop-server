...
// 		if updateErr := core.GeneratedReportManager(service).UpdateByID(ctx, id, generatedReport); updateErr != nil {
...
// 			if err := core.GeneratedReportManager(service).UpdateByID(ctx, id, generatedReport); err != nil {
...
// 		generatedReport, getErr := core.GeneratedReportManager(service).GetByID(ctx, id)
// 		if getErr != nil {
// 			generatedReport.Status = core.GeneratedReportStatusFailed
...
// 			if mediaErr := core.MediaManager(service).Create(ctx, initial); mediaErr != nil {
// 				generatedReport.Status = core.GeneratedReportStatusFailed
...
// 			storage, uploadErr :=service.Storage.UploadFromBinaryWithContentType(
// 				ctx,
// 				data,
// 				fileName,
...
// 					if err := core.MediaManager(service).UpdateByID(ctx, initial.ID, initial); err != nil {
...
// 			if mediaUpdateErr := core.MediaManager(service).UpdateByID(ctx, completed.ID, completed); mediaUpdateErr != nil {
// 				generatedReport.Status = core.GeneratedReportStatusFailed
