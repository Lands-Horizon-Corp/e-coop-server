...
func CashCheckVoucherTagManager(service *horizon.HorizonService) *registry.Registry[CashCheckVoucherTag, CashCheckVoucherTagResponse, CashCheckVoucherTagRequest] {
...
func CashCheckVoucherTagCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*CashCheckVoucherTag, error) {
	return CashCheckVoucherTagManager(service).Find(context, &CashCheckVoucherTag{
