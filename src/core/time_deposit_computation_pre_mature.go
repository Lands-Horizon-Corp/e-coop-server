...
func TimeDepositComputationPreMatureManager(service *horizon.HorizonService) *registry.Registry[TimeDepositComputationPreMature, TimeDepositComputationPreMatureResponse, TimeDepositComputationPreMatureRequest] {
...
func TimeDepositComputationPreMatureCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*TimeDepositComputationPreMature, error) {
	return TimeDepositComputationPreMatureManager(service).Find(context, &TimeDepositComputationPreMature{
