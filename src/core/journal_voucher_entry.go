...
func JournalVoucherEntryManager(service *horizon.HorizonService) *registry.Registry[JournalVoucherEntry, JournalVoucherEntryResponse, JournalVoucherEntryRequest] {
...
func JournalVoucherEntryCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*JournalVoucherEntry, error) {
	return JournalVoucherEntryManager(service).Find(context, &JournalVoucherEntry{
