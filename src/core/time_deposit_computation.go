...
func TimeDepositComputationManager(service *horizon.HorizonService) *registry.Registry[TimeDepositComputation, TimeDepositComputationResponse, TimeDepositComputationRequest] {
...
func TimeDepositComputationCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*TimeDepositComputation, error) {
	return TimeDepositComputationManager(service).Find(context, &TimeDepositComputation{
