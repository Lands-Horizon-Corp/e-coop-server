...
func MemberIncomeManager(service *horizon.HorizonService) *registry.Registry[MemberIncome, MemberIncomeResponse, MemberIncomeRequest] {
	return registry.NewRegistry(registry.RegistryParams[MemberIncome, MemberIncomeResponse, MemberIncomeRequest]{
		...
		Created: func(data *MemberIncome) registry.Topics {
			return []string{
		...
		Updated: func(data *MemberIncome) registry.Topics {
			return []string{
		...
		Deleted: func(data *MemberIncome) registry.Topics {
			return []string{
...
func MemberIncomeCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*MemberIncome, error) {
	return MemberIncomeManager(service).Find(context, &MemberIncome{
