...
func ChargesRateSchemeModeOfPaymentManager(service *horizon.HorizonService) *registry.Registry[ChargesRateSchemeModeOfPayment, ChargesRateSchemeModeOfPaymentResponse, ChargesRateSchemeModeOfPaymentRequest] {
...
func ChargesRateSchemeModeOfPaymentCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*ChargesRateSchemeModeOfPayment, error) {
	return ChargesRateSchemeModeOfPaymentManager(service).Find(context, &ChargesRateSchemeModeOfPayment{
