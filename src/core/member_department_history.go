...
func MemberDepartmentHistoryManager(service *horizon.HorizonService) *registry.Registry[MemberDepartmentHistory, MemberDepartmentHistoryResponse, MemberDepartmentHistoryRequest] {
...
func MemberDepartmentHistoryCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*MemberDepartmentHistory, error) {
	return MemberDepartmentHistoryManager(service).Find(context, &MemberDepartmentHistory{
		OrganizationID: organizationID,
		BranchID:       branchID,
	})
}

func MemberDepartmentHistoryMemberProfileID(context context.Context, service *horizon.HorizonService, memberProfileID, organizationID, branchID uuid.UUID) ([]*MemberDepartmentHistory, error) {
	return MemberDepartmentHistoryManager(service).Find(context, &MemberDepartmentHistory{
		OrganizationID:  organizationID,
		BranchID:        branchID,
