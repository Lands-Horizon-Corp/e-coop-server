...
func InterestRateByTermManager(service *horizon.HorizonService) *registry.Registry[InterestRateByTerm, InterestRateByTermResponse, InterestRateByTermRequest] {
...
func InterestRateByTermCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*InterestRateByTerm, error) {
	return InterestRateByTermManager(service).Find(context, &InterestRateByTerm{
