...
func LoanClearanceAnalysisManager(service *horizon.HorizonService) *registry.Registry[LoanClearanceAnalysis, LoanClearanceAnalysisResponse, LoanClearanceAnalysisRequest] {
	return registry.NewRegistry(registry.RegistryParams[
		...
		Created: func(data *LoanClearanceAnalysis) registry.Topics {
			return []string{
		...
		Updated: func(data *LoanClearanceAnalysis) registry.Topics {
			return []string{
		...
		Deleted: func(data *LoanClearanceAnalysis) registry.Topics {
			return []string{
...
func LoanClearanceAnalysisCurrentBranch(context context.Context, service *horizon.HorizonService, organizationID uuid.UUID, branchID uuid.UUID) ([]*LoanClearanceAnalysis, error) {
	return LoanClearanceAnalysisManager(service).Find(context, &LoanClearanceAnalysis{
