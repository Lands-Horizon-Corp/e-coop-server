...
func (m *Model) GeneralLedgerAccountsGrouping() {
	...
	m.GeneralLedgerAccountsGroupingManager = horizon_services.NewRepository(horizon_services.RepositoryParams[GeneralLedgerAccountsGrouping, GeneralLedgerAccountsGroupingResponse, GeneralLedgerAccountsGroupingRequest]{
		Preloads: []string{
			...
			"GeneralLedgerDefinitions.GeneralLedgerAccountsGrouping",
			"GeneralLedgerDefinitions.CreatedBy",
			"GeneralLedgerDefinitions.UpdatedBy",
			"GeneralLedgerDefinitions.GeneralLedgerDefinition",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.Accounts",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinition",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.Accounts",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinition",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.Accounts",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinition",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.Accounts",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinition",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries",
			"GeneralLedgerDefinitions.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.GeneralLedgerDefinitionEntries.Accounts",
		},
