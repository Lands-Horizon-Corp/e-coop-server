...
type (
	MemberCloseRemark struct {
		...
		MemberProfile   *MemberProfile `gorm:"foreignKey:MemberProfileID;references:ID;constraint:OnDelete:RESTRICT,OnUpdate:CASCADE;" json:"member_profile,omitempty"`
...
func (m *Model) MemberCloseRemark() {
...
func (m *Model) MemberCloseRemarkCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*MemberCloseRemark, error) {
