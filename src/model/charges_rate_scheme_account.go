...
func (m *Model) ChargesRateSchemeAccount() {
	...
	m.ChargesRateSchemeAccountManager = horizon_services.NewRepository(horizon_services.RepositoryParams[
		...
		Preloads: []string{
			"CreatedBy", "UpdatedBy", "DeletedBy", "Branch", "Organization", "ChargesRateScheme", "Account",
		},
...
func (m *Model) ChargesRateSchemeAccountCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*ChargesRateSchemeAccount, error) {
