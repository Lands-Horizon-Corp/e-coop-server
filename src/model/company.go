...
func (m *Model) CompanySeed(context context.Context, tx *gorm.DB, userID uuid.UUID, organizationID uuid.UUID, branchID uuid.UUID) error {
	now := time.Now().UTC()
...
func (m *Model) CompanyCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*Company, error) {
