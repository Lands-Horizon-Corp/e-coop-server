...
func (m *ModelCore) ChargesRateByTermHeader() {
...
func (m *ModelCore) ChargesRateByTermHeaderCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*ChargesRateByTermHeader, error) {
