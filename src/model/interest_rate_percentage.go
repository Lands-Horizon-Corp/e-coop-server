...
func (m *Model) InterestRatePercentage() {
...
func (m *Model) InterestRatePercentageCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*InterestRatePercentage, error) {
