...
func (m *Model) LoanGuaranteedFundPerMonth() {
...
func (m *Model) LoanGuaranteedFundPerMonthCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*LoanGuaranteedFundPerMonth, error) {
