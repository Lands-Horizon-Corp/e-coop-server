...
func (m *Model) MemberOtherInformationEntry() {
...
func (m *Model) MemberOtherInformationEntryCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*MemberOtherInformationEntry, error) {
