			...
			definitions = []*GeneralLedgerDefinition{
				{
					...
					BranchID:                        branchID,
					GeneralLedgerAccountsGroupingID: &groupingData.ID,
					GeneralLedgerDefinitionID:       &currentAssetsParent.ID,
					Name:                            "Cash on Hand",
			...
			definitions = []*GeneralLedgerDefinition{
				{
					...
					BranchID:                        branchID,
					GeneralLedgerAccountsGroupingID: &groupingData.ID,
					GeneralLedgerDefinitionID:       &liabilitiesParent.ID,
				...
				},
				{
					...
					BranchID:                        branchID,
					GeneralLedgerAccountsGroupingID: &groupingData.ID,
					GeneralLedgerDefinitionID:       &equityParent.ID,
					Name:                            "Share Capital",
			...
			definitions = []*GeneralLedgerDefinition{
				{
					...
					BranchID:                        branchID,
					GeneralLedgerAccountsGroupingID: &groupingData.ID,
					GeneralLedgerDefinitionID:       &operatingExpensesParent.ID,
