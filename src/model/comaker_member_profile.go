...
func (m *Model) ComakerMemberProfile() {
...
func (m *Model) ComakerMemberProfileCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*ComakerMemberProfile, error) {
...
func (m *Model) ComakerMemberProfileByLoanTransaction(context context.Context, loanTransactionId uuid.UUID) ([]*ComakerMemberProfile, error) {
	return m.ComakerMemberProfileManager.Find(context, &ComakerMemberProfile{
