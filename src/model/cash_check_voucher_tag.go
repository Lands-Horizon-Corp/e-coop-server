...
func (m *Model) CashCheckVoucherTag() {
...
func (m *Model) CashCheckVoucherTagCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*CashCheckVoucherTag, error) {
