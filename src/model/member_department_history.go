...
func (m *Model) MemberDepartmentHistory() {
...
func (m *Model) MemberDepartmentHistoryCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*MemberDepartmentHistory, error) {
...
func (m *Model) MemberDepartmentHistoryMemberProfileID(context context.Context, memberProfileId, orgId, branchId uuid.UUID) ([]*MemberDepartmentHistory, error) {
	return m.MemberDepartmentHistoryManager.Find(context, &MemberDepartmentHistory{
		OrganizationID:  orgId,
		BranchID:        branchId,
