...
func (m *Model) GroceryComputationSheet() {
...
func (m *Model) GroceryComputationSheetCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*GroceryComputationSheet, error) {
