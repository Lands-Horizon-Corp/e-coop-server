...
func (m *Model) CashCheckVoucherEntry() {
...
func (m *Model) CashCheckVoucherEntryCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*CashCheckVoucherEntry, error) {
