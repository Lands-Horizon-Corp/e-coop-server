...
func (m *Model) ComakerCollateral() {
...
func (m *Model) ComakerCollateralCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*ComakerCollateral, error) {
...
func (m *Model) ComakerCollateralByLoanTransaction(context context.Context, loanTransactionId uuid.UUID) ([]*ComakerCollateral, error) {
	return m.ComakerCollateralManager.Find(context, &ComakerCollateral{
