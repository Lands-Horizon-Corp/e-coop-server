...
func (m *Model) LoanClearanceAnalysis() {
...
func (m *Model) LoanClearanceAnalysisCurrentBranch(context context.Context, orgId uuid.UUID, branchId uuid.UUID) ([]*LoanClearanceAnalysis, error) {
