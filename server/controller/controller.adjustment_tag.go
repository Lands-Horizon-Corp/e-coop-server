...
func (c *Controller) adjustmentTagController(
	...
	req.RegisterRoute(handlers.Route{
		...
		ResponseType: modelcore.AdjustmentTagResponse{},
		...
		return ctx.JSON(http.StatusOK, c.modelcore.AdjustmentTagManager.Filtered(context, ctx, tags))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		return ctx.JSON(http.StatusOK, c.modelcore.AdjustmentTagManager.Pagination(context, ctx, tags))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		tag, err := c.modelcore.AdjustmentTagManager.GetByIDRaw(context, *tagID)
		if err != nil {
	...
	req.RegisterRoute(handlers.Route{
		...
		RequestType:  modelcore.AdjustmentTagRequest{},
		ResponseType: modelcore.AdjustmentTagResponse{},
	}, func(ctx echo.Context) error {
		context := ctx.Request().Context()
		req, err := c.modelcore.AdjustmentTagManager.Validate(ctx)
		if err != nil {
		...
		if err := c.modelcore.AdjustmentTagManager.Create(context, tag); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "create-error",
		...
		return ctx.JSON(http.StatusCreated, c.modelcore.AdjustmentTagManager.ToModel(tag))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		tags, err := c.modelcore.AdjustmentTagManager.Find(context, &modelcore.AdjustmentTag{
	...
	req.RegisterRoute(handlers.Route{
		...
		tag, err := c.modelcore.AdjustmentTagManager.GetByID(context, *tagID)
		if err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		if err := c.modelcore.AdjustmentTagManager.UpdateFields(context, tag.ID, tag); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "update-error",
		...
		return ctx.JSON(http.StatusOK, c.modelcore.AdjustmentTagManager.ToModel(tag))
	})
	...
	req.RegisterRoute(handlers.Route{
		...
		if err := c.modelcore.AdjustmentTagManager.DeleteByID(context, *tagID); err != nil {
			c.event.Footstep(context, ctx, event.FootstepEvent{
				Activity:    "delete-error",
