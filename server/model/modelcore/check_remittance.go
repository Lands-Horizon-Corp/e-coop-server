...
func (m *ModelCore) checkRemittance() {
	...
	m.CheckRemittanceManager = services.NewRepository(services.RepositoryParams[
...
func (m *ModelCore) CheckRemittanceCurrentBranch(context context.Context, organizationID uuid.UUID, branchID uuid.UUID) ([]*CheckRemittance, error) {
