...
func (m *ModelCore) memberGenderHistory() {
	...
	m.MemberGenderHistoryManager = services.NewRepository(services.RepositoryParams[MemberGenderHistory, MemberGenderHistoryResponse, MemberGenderHistoryRequest]{
