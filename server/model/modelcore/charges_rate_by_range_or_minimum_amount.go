...
func (m *ModelCore) ChargesRateByRangeOrMinimumAmountCurrentBranch(context context.Context, organizationID uuid.UUID, branchID uuid.UUID) ([]*ChargesRateByRangeOrMinimumAmount, error) {
