...
func (m *ModelCore) memberContactReference() {
	...
	m.MemberContactReferenceManager = services.NewRepository(services.RepositoryParams[MemberContactReference, MemberContactReferenceResponse, MemberContactReferenceRequest]{
