...
func (m *Core) memberTypeReferenceByAmount() {
	m.Migration = append(m.Migration, &MemberTypeReferenceByAmount{})
	m.MemberTypeReferenceByAmountManager = *registry.NewRegistry(registry.RegistryParams[
...
func (m *Core) MemberTypeReferenceByAmountCurrentBranch(context context.Context, organizationID uuid.UUID, branchID uuid.UUID) ([]*MemberTypeReferenceByAmount, error) {
