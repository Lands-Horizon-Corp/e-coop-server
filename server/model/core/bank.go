...
func (m *Core) bankSeed(context context.Context, tx *gorm.DB, userID uuid.UUID, organizationID uuid.UUID, branchID uuid.UUID) error {
	...
	banks := []*Bank{
		...
		// Global e-wallets / payment platforms
	...
	case "USA": // United States
		banks = append(banks,
			...
			// === Investment / Global Financial Institutions ===
			...
			// === Credit Unions (Famous Nationwide) ===
	...
	case "CHN": // China
		banks = append(banks,
			...
			// Other Well-Known Chinese Banks
			...
			// Digital Banks / E-Wallets / Fintech
	...
	case "SWE": // Sweden
		banks = append(banks,
			...
			// Sweden Digital Banks / E-Wallets
	...
	case "NZL": // New Zealand
		banks = append(banks,
			...
			// Digital / Mobile Banks & E-Wallets
	...
	case "PHL": // Philippines
		banks = append(banks,
			...
			// E-Wallets (Most Popular in the Philippines)
			...
			// Rural Banks / Microfinance Banks (Well-known Nationwide)
