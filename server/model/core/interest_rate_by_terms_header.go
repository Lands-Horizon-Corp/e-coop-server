...
type (
	// InterestRateByTermsHeader represents the InterestRateByTermsHeader model.
	...
	// InterestRateByTermsHeaderResponse represents the response structure for InterestRateByTermsHeader.
	...
	// InterestRateByTermsHeaderRequest represents the request structure for InterestRateByTermsHeader.
...
func (m *Core) interestRateByTermsHeader() {
	m.Migration = append(m.Migration, &InterestRateByTermsHeader{})
	m.InterestRateByTermsHeaderManager = *registry.NewRegistry(registry.RegistryParams[
...
func (m *Core) InterestRateByTermsHeaderCurrentBranch(context context.Context, organizationID uuid.UUID, branchID uuid.UUID) ([]*InterestRateByTermsHeader, error) {
