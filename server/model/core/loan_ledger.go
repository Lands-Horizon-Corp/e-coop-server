...
func (m *Core) loanLedger() {
	m.Migration = append(m.Migration, &LoanLedger{})
	m.LoanLedgerManager = *registry.NewRegistry(registry.RegistryParams[
...
func (m *Core) LoanLedgerCurrentBranch(context context.Context, organizationID uuid.UUID, branchID uuid.UUID) ([]*LoanLedger, error) {
