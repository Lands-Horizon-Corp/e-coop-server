...
func (m *Core) memberTypeReferenceInterestRateByUltimaMembershipDate() {
	m.Migration = append(m.Migration, &MemberTypeReferenceInterestRateByUltimaMembershipDate{})
	m.MemberTypeReferenceInterestRateByUltimaMembershipDateManager = *registry.NewRegistry(registry.RegistryParams[
...
func (m *Core) MemberTypeReferenceInterestRateByUltimaMembershipDateCurrentBranch(context context.Context, organizationID uuid.UUID, branchID uuid.UUID) ([]*MemberTypeReferenceInterestRateByUltimaMembershipDate, error) {
