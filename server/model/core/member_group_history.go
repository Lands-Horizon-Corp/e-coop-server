...
func (m *Core) memberGroupHistory() {
	...
	m.MemberGroupHistoryManager = *registry.NewRegistry(registry.RegistryParams[MemberGroupHistory, MemberGroupHistoryResponse, MemberGroupHistoryRequest]{
		...
		Created: func(data *MemberGroupHistory) registry.Topics {
			return []string{
		...
		Updated: func(data *MemberGroupHistory) registry.Topics {
			return []string{
		...
		Deleted: func(data *MemberGroupHistory) registry.Topics {
			return []string{
